...
This mini-project is a **Console-Based Calculator** developed in Python (or your chosen language). [cite_start]The primary goal was to create a fully functional, reliable application capable of performing the four basic arithmetic operations: addition, subtraction, multiplication, and division[cite: 27]. The project serves as a practical demonstration of several core concepts:

* **Fundamental Programming:** Use of functions, loops, and conditional logic.
* [cite_start]**Development Tools:** Efficient use of Visual Studio Code (VS Code) for development[cite: 32].
* [cite_start]**Version Control:** Maintenance and tracking of project history using a Git repository[cite: 33].
* [cite_start]**Documentation:** Creating clear, professional documentation in Markdown format[cite: 63].

---

## 2. Development Process (How I Built It)

[cite_start]The project followed a structured development workflow, ensuring proper use of version control and creating a history of changes (at least 5 meaningful commits [cite: 42]).

1.  [cite_start]**Repository Setup:** The project folder was initialized as a Git repository (`git init`) [cite: 38] and created within VS Code.
...
5.  [cite_start]**Final Documentation:** The project was finalized by creating the required files: the `.gitignore` file [cite: 45][cite_start], the `README.md` file [cite: 46][cite_start], and this documentation file within the dedicated `docs/` folder.
